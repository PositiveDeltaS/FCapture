...
# Following field is required for state record, ends up looking cool anyways
...
$VNCServerBtn.Add_Click({ VNC-Server })
...
# Adds click event handlers to buttons so all changes changes result in a state update
Initialize-MainForm
